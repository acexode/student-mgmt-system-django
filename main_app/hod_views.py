...
def add_course(request):
    ...
    if request.method == 'POST':
        if form.is_valid():
            ...
            creditUnit = form.cleaned_data.get('creditUnit')
            academicLevel = form.cleaned_data.get('academicLevel')
            section = form.cleaned_data.get('section')
            academicYear = form.cleaned_data.get('academicYear')
            ...
            try:
                ...
                course.academicLevel = academicLevel
